...
class Student:
    def __init__(self,root):
        ...
        self.var_std_semester=StringVar()
        self.var_std_section=StringVar()
        self.var_std_course=StringVar()
    ...
    # This part is image labels setting start 
        ...
        #combo box 
        year_combo=ttk.Combobox(current_course_frame,textvariable=self.var_std_year,width=15,font=("verdana",12,"bold"),state="readonly")
        ...
        #combo box 
        year_combo=ttk.Combobox(current_course_frame,textvariable=self.var_std_semester,width=15,font=("verdana",12,"bold"),state="readonly")
        year_combo["values"]=("Select Semester","Semester-1","Semester-2")
        year_combo.current(0)
        ...
        class_Student_frame.place(x=10,y=200,width=635,height=230)
        ...
        #combo box 
        gender_combo=ttk.Combobox(class_Student_frame,textvariable=self.var_std_gender,width=13,font=("verdana",12,"bold"),state="readonly")
        ...
        student_email_entry = ttk.Entry(class_Student_frame,textvariable=self.var_std_email,width=15,font=("verdana",12,"bold"))
        ...
        student_mob_entry = ttk.Entry(class_Student_frame,textvariable=self.var_std_phone,width=15,font=("verdana",12,"bold"))
       ...
       # take_photo_btn=Button(btn_frame,text="Take Pic",width=9,font=("verdana",12,"bold"),fg="white",bg="navyblue")
        ...
        search_combo["values"]=("Select","std_id")
